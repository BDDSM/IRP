...
Procedure PredefinedDescriptions(Strings, CodeLanguage)
	...
	Strings.Insert("Description_A062", NStr("en='Credit note';tr='Kredi notu'", CodeLanguage));
	Strings.Insert("Description_A063", NStr("en='Debit note';tr='Borç senedi'", CodeLanguage));
